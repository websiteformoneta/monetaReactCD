...
function HeroSplit({ tagline, title, accentWord, description, ctaLabel, onCta, right }) {
  // Replaces a substring in `title` with the gradient-styled accent word
  const renderTitle = () => {
      ...
      <div className="container-x relative">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center">
          <div className="lg:col-span-6">
            ...
            {description && (
              <p className="mt-7 text-[18px] md:text-[19px] leading-[1.6] text-ink-secondary max-w-[560px]">
                {description}
              </p>
            )}
            <div className="mt-9">
  ...
  return (
    <React.Fragment>
      ...
      <SectionShell dotsRight>
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          <div className="lg:col-span-5">
            ...
            <p className="mt-3 text-[16px] leading-[1.7] text-white font-semibold">
              Hidden margin loss is the result.
            </p>
            ...
            <p className="mt-3 text-[16px] leading-[1.7] text-white font-semibold">
              Margins lack visibility and control.
            </p>
          </div>

          <div className="lg:col-span-7 space-y-3">
            {[
              { t: "Discount programs are hard to track and inconsistently applied", i: "tag",     c: "#3B82F6" },
              { t: "Customer pricing is disconnected from actual cloud costs",       i: "cloud",   c: "#22D3EE" },
              { t: "Billing relies on spreadsheets and manual work",                 i: "sheet",   c: "#A855F7" },
              { t: "Misapplied discounts and pricing gaps reduce margins",           i: "percent", c: "#F59E0B" },
              { t: "Limited visibility into margin performance by customer",        i: "bars",    c: "#22D3EE" },
            ].map((row) => (
              <div key={row.t} className="card flex items-center gap-5 px-5 py-4 hover:border-line-hover">
                <div className="w-14 h-14 grid place-items-center shrink-0">{Icons[row.i](row.c)}</div>
        ...
        {/* Bottom line callout */}
        <div className="mt-14 relative card !rounded-2xl px-7 py-7 md:px-10 md:py-8" style={{ borderColor: "rgba(34,211,238,0.35)" }}>
          <div className="flex items-center gap-6">
            ...
            <div className="border-l border-line-soft pl-6">
              <p className="eyebrow text-accent-cyan mb-2" style={{ color: "#22D3EE" }}>The Bottom Line</p>
      ...
      <SectionShell className="bg-bg-secondary border-t border-line-soft" dotsRight>
        ...
        {/* Bottom line band */}
        <div className="mt-14 relative card !rounded-2xl px-7 py-7 md:px-10 md:py-8" style={{ borderColor: "rgba(168,85,247,0.4)" }}>
          <div className="flex items-center gap-6">
            <div className="w-14 h-14 rounded-xl grid place-items-center shrink-0">
              <svg width="34" height="34" viewBox="0 0 24 24" fill="none" stroke="#22D3EE" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
                <circle cx="12" cy="12" r="9" /><circle cx="12" cy="12" r="5" /><circle cx="12" cy="12" r="1.5" fill="#22D3EE" />
              </svg>
            </div>
            <div className="border-l border-line-soft pl-6">
  ...
  return (
    <React.Fragment>
        ...
        <div className="container-x relative">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            <div className="lg:col-span-6">
              ...
              <p className="mt-7 text-[17.5px] leading-[1.7] text-ink-secondary max-w-[520px]">
              ...
              <p className="mt-4 grad-text-bp text-[16px] font-semibold">
            ...
            <div className="lg:col-span-6">
              <div className="mb-7">
                <Eyebrow>Core System Layers</Eyebrow>
              </div>
              <CoreSystemLayers />
            </div>
          </div>
      ...
      <SectionShell>
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          <div className="lg:col-span-5">
            <Eyebrow className="mb-7">A System Built for Cloud Resale Operations</Eyebrow>
            <h3 className="text-h2 text-balance">
              Cloud resellers operate across complex billing, pricing, and margin environments.
            </h3>
          </div>
          <div className="lg:col-span-7 space-y-5 text-[16.5px] leading-[1.75] text-ink-secondary">
      ...
      <SectionShell className="bg-bg-secondary border-t border-line-soft" dotsRight>
        ...
        <div className="mt-12 pl-5 border-l-2 grad-line">
          <p className="text-[16.5px] leading-[1.7] text-ink-secondary max-w-[860px]">
            Built specifically for AWS and Azure resellers operating across multiple customers, pricing models, and discount programs —
            where billing, pricing, and margin must remain continuously aligned.
          </p>
        </div>
      </SectionShell>
      ...
      <SectionShell className="bg-bg-secondary border-t border-line-soft">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-7 space-y-5 text-[16.5px] leading-[1.7] text-ink-secondary">
            ...
            <p>
              moneta replaces that operational debt with a system that owns the cost-to-invoice loop end to end.
            </p>
          </div>
        </div>
      </SectionShell>
